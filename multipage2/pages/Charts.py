...
with tab1:
    ...
    with st.container():
        ...
        st.write('<h3 style="text-align: center; color : MediumAquaMarine;">Correlation Between Numerical features with filters</h3>', unsafe_allow_html=True)
...
with tab2:
    st.markdown('<h3 style="text-align: center; color : MediumAquaMarine;">Distribution of Categorical features</h3>', unsafe_allow_html=True)
    ...
    with st.container():
        ...
        col3.plotly_chart(fig,use_container_width=True)
        st.write('<h3 style="text-align: center; color : MediumAquaMarine;">Some BiVariate Analysis</h3>', unsafe_allow_html=True)
